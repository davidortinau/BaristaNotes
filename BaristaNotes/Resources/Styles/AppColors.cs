...
public static class AppColors
{
    ...
    {
        public static Color Background = Color.FromArgb("#FFF8F0");
        public static Color Surface = Color.FromArgb("#FFFFFF");
        public static Color Card = Color.FromArgb("#F5EDE3");
        public static Color EspressoAccent = Color.FromArgb("#3E2723");
        public static Color Caramel = Color.FromArgb("#B8835A");

        public static Color PrimaryText = Color.FromArgb("#1A0F0A");
        public static Color SecondaryText = Color.FromArgb("#5D4E46");
        public static Color DisabledText = Color.FromArgb("#9E9E9E");
    }
}
